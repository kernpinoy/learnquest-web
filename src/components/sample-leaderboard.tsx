...
export default function ClassManagement() {
  ...
  const learningMaterials = [
    ...
    {
      name: "Shakespeare Introduction.docx",
      type: "file",
      icon: <FileText className="h-4 w-4" />,
    },
    {
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="mb-4 flex space-x-2">
                  <Button
                    variant={
                      activeLeaderboardTab === "today" ? "default" : "outline"
                    }
                  ...
                  <Button
                    variant={
                      activeLeaderboardTab === "allTime" ? "default" : "outline"
                    }
